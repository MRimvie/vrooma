...
import 'package:vrooma/helpers/my_widgets/my.dart';
...
import 'package:vrooma/helpers/my_widgets/my_text_style.dart';
...
class AppStyle {
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      MyBreadcrumbItem(name: 'vrooma', route: '/dashboard'),
    ));
    bool isMobile = true;
    try {
